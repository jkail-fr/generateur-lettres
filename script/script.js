...
preset9.addEventListener('click', function(){generatePreset(9);});
preset10.addEventListener('click', function(){generatePreset(10);});
preset11.addEventListener('click', function(){generatePreset(11);});
preset12.addEventListener('click', function(){generatePreset(12);});
